...
def train(args: Namespace, df: pd.DataFrame, trial: optuna.trial._trial.Trial = None) -> Dict:
    ...
    Args:
        ...
        trial (optuna.trial._trial.Trial, optional): _description_. Defaults to None.
...
def objective(args: Namespace, df: pd.DataFrame, trial: optuna.trial._trial.Trial = None) -> float:
    ...
    """
    # Parameters to tune
    args = Namespace(**utils.load_dict(filepath=args))
